  ...
  ({ employee, side, template, photoUrl }, ref) => {
    ...
    return (
      ...
      >
        ...
        {/* 2️⃣ PHOTO - left-[44.5px] top-[81px] w-[64px] h-[80px] - Moved down 13px total */}
        <div
        ...
        {/* 3️⃣ NAME - left-0 top-[160px] w-[153px] h-[20px] - PERFECT POSITION */}
        <div
          style={{
            position: 'absolute',
            left: 0,
        ...
        {/* 4️⃣ EMPLOYEE ID - left-0 top-[192px] w-[153px] h-[10px] */}
        <div
          style={{
            position: 'absolute',
            left: 0,
        ...
        {/* 5️⃣ CONTACT ROW - top-[210px] - Original position */}
        ...
        {/* 6️⃣ VALID TILL - left-0 top-[227px] w-[153px] h-[7px] - Original position */}
        <div
          style={{
            position: 'absolute',
            left: 0,
